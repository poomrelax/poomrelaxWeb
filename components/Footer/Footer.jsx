...
function Footer() {
  return (
    ...
    <footer className={stylesFooter.container}>
      ...
      <div style={{width: '75%', height: '1px', background: '#fff', margin: '35px 0'}} className={stylesFooter.underline}></div>
    <div style={{width: '75%', display: 'flex', justifyContent: 'space-between'}} className={stylesFooter.bottom}>
      ...
      <div style={{display: 'flex', gap: '10px'}} className={stylesFooter.image}>
